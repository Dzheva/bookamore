  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-3 flex items-center border-b border-gray-100">
        ...
        <h1 className="text-base sm:text-lg lg:text-xl font-semibold flex-1 text-center">Book Details</h1>
      ...
      <div className="w-full max-w-md mx-auto lg:max-w-4xl xl:max-w-6xl">
          ...
          <div className="flex flex-col lg:flex-row lg:gap-8">
            ...
            <div className="w-full lg:w-1/3">
              <div className="w-32 sm:w-40 lg:w-full flex-shrink-0 h-44 sm:h-56 lg:h-80 rounded-xl bg-gray-100 flex items-center justify-center mx-auto lg:mx-0">
                {images.length > 0 && images[imgIndex] ? (
                  ...
                  <span className="text-2xl sm:text-4xl lg:text-6xl text-gray-400">ФОТО</span>
                )}
              </div>
            ...
            <div className="flex-1 flex flex-col mt-4 lg:mt-0">
              ...
              <div className="flex items-start justify-between mb-1 sm:mb-2">
                <h2 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold flex-1 pr-2">{book.title}</h2>
                <button 
                  onClick={handleFavoriteToggle} 
                  className="p-1"
                >
                  {isFavorite ? <IoHeart className="w-6 h-6 lg:w-8 lg:h-8 text-red-500" /> : <IoHeartOutline className="w-6 h-6 lg:w-8 lg:h-8 text-gray-800" />}
                </button>
              </div>
              
              <p className="text-sm sm:text-base lg:text-lg text-gray-500 mb-4 font-semibold">{book.authors?.join(', ')}</p>

              {/* price + exchange button */}
              <div className="flex items-center justify-between mb-3 lg:mb-4">
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">{offer.price} UAH</p>
              ...
              <div className="flex items-center justify-between mb-4 lg:mb-6">
                ...
                <span className="px-3 py-1 lg:px-4 lg:py-2 rounded-full bg-gray-100 text-xs lg:text-sm font-semibold uppercase text-gray-700">New</span>
              </div>
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
          <div className="space-y-3 lg:space-y-4">
            <div className="flex items-center">
              <span className="text-base lg:text-lg font-semibold text-gray-800 w-24 lg:w-32">Language</span>
              <span className="px-3 py-1 lg:px-4 lg:py-2 bg-gray-100 rounded-full text-sm lg:text-base font-medium text-gray-700">Ukrainian</span>
            </div>
            <div className="flex items-center">
              <span className="text-base lg:text-lg font-semibold text-gray-800 w-24 lg:w-32">Pages</span>
              <span className="px-3 py-1 lg:px-4 lg:py-2 bg-gray-100 rounded-full text-sm lg:text-base font-medium text-gray-700">430</span>
            </div>
            <div className="flex items-start">
              <span className="text-base lg:text-lg font-semibold text-gray-800 w-24 lg:w-32 mt-1">Category</span>
              <div className="flex flex-wrap gap-2">
                {(book.genres?.length ? book.genres : ['Fantasy', 'Fantasy']).map((g: string, i: number) => (
                  <span key={`${g}-${i}`} className="px-3 py-1 lg:px-4 lg:py-2 bg-gray-100 rounded-full text-sm lg:text-base font-medium text-gray-700">
                    {g}
                  </span>
                ))}
              </div>
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
          ...
          >
            <span className="text-base lg:text-lg font-semibold text-gray-800">About the book</span>
          ...
          {isAboutOpen && (
            <div className="mt-2 lg:mt-4 text-sm lg:text-base text-gray-600">
              ...
              <p className="text-xs lg:text-sm font-semibold text-gray-800 mt-4">Date added: {new Date().toLocaleDateString('en-GB')}</p>
            </div>
          )}
        </div>
        ...
        {/* Owner */}
        <div className="px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
          <p className="text-base lg:text-lg font-semibold text-gray-800 mb-3 lg:mb-4">The Owner</p>
          <div className="flex items-center gap-3 lg:gap-4">
            ...
            <span className="font-medium text-gray-800 text-sm lg:text-base">{seller.name}</span>
          </div>
        </div>
        ...
        {/* Similar books */}
        <div className="px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
          <p className="text-base lg:text-lg font-semibold text-gray-800 mb-3 lg:mb-4">Similar books</p>
            ...
            {similarBooks.length > 0 ? (
              similarBooks.map((similarOffer) => (
                ...
                >
                  ...
                  <p className="text-xs lg:text-sm text-gray-600 truncate">{similarOffer.book.title}</p>
                  <p className="text-xs lg:text-sm font-semibold text-gray-800">{similarOffer.price} UAH</p>
                </div>
              ))
            ) : (
