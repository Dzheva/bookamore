    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white px-4 sm:px-6 lg:px-8 py-3 flex items-center border-b border-gray-200">
                ...
                <h1 className="text-lg sm:text-xl lg:text-2xl font-semibold flex-1 text-center">My Favorites</h1>
                ...
                {favorites.length > 0 ? (
                    <>
                        ...
                        <div className="px-4 sm:px-6 lg:px-8 py-4 bg-white">
                            <p className="text-sm sm:text-base text-gray-600">{favorites.length} items on your list</p>
                            <p className="text-sm sm:text-base lg:text-lg font-semibold text-gray-800">Your Total: {totalValue} UAH</p>
                        </div>
                        ...
                        <div className="px-4 sm:px-6 lg:px-8 py-4 space-y-4 lg:grid lg:grid-cols-3 xl:grid-cols-4 lg:gap-6 lg:space-y-0">
                            {favorites.map((item) => (
                                <div key={item.id} className="bg-white rounded-lg shadow-sm
                                    ...
                                    {/* Book Image */}
                                    <div className="w-20 h-24 sm:w-24 sm:h-28 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0
                                    ...
                                    <div className="flex-1 lg:p-4 lg:flex lg:flex-col">
                                        <div className="flex items-start justify-between mb-1">
                                            <h3 className="font-semibold text-gray-900 text-sm sm:text-base lg:text-lg">{item.book.title}</h3>
                                            <button 
                                        ...
                                        <div className="flex items-center justify-between mb-3 lg:flex-col lg:items-start lg:gap-2 lg:mb-4">
                                            <div>
                                                ...
                                                <p className="font-semibold text-gray-900 text-sm sm:text-base lg:text-lg">{item.price} UAH</p>
                                            </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
                        ...
                        <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-gray-900 mb-2">No favorites yet</h2>
