...
Always Free покриває **одну** e2-micro у `us-west1`, `us-central1` або `us-east1`,
30 GB **standard** persistent disk і 1 GB вихідного трафіку з Північної Америки.
...
### 3.1 Фаєрвол: закрити прямий доступ по IP
